...
default: 
	...
	$(CC) -DMINI_HTTPD_  $(DEBUG) $(OPTIMIZATIONS) -c fuzzer.c -g -ggdb -o fuzzer.o
	...
	$(CC) lib/util.o fuzzer.o lib/fuzzerlib.o lib/requestlib.o lib/httpdsig.o mini_httpd-1.30/mini_httpd.o mini_httpd-1.30/match.o mini_httpd-1.30/tdate_parse.o $(LDLIBS) -o ./fuzzer; 
	mkdir -p logs
clean:
	if [ -d mini_httpd-1.30 ]; then \
